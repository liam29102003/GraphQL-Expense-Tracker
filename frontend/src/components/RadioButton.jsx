		...
		<div className='inline-flex items-center'>
			<label className='relative flex items-center p-3 rounded-full cursor-pointer' htmlFor={id}>
				<input
					...
					checked={checked}
				/>
				<span className='absolute text-gray-100 transition-opacity opacity-0 pointer-events-none top-2/4 left-2/4 -translate-y-2/4 -translate-x-2/4 peer-checked:opacity-100'>
					<svg
			...
			<label className='mt-px font-light text-gray-100 cursor-pointer select-none' htmlFor={id}>
				{label}
			</label>
		</div>
	);
