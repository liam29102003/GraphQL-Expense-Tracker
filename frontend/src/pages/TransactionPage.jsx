...
const TransactionPage = () => {
	...
	return (
		<div className='h-screen max-w-4xl mx-auto flex flex-col items-center'>
			<p className='md:text-4xl text-2xl lg:text-4xl font-bold text-center relative z-50 mb-4 mr-4 bg-gradient-to-r from-green-600 via-emerald-500 to-green-300 inline-block text-transparent bg-clip-text'>
				...
				<div className='flex flex-wrap gap-3'>
					<div className='w-full flex-1 mb-6 md:mb-0'>
						...
						<div className='relative'>
							<select
								className='block appearance-none w-full bg-gray-200 border border-gray-200 text-gray-700 py-3 px-4 pr-8 rounded leading-tight focus:outline-none focus:bg-white focus:border-green-500'
								id='paymentType'
								name='paymentType'
								onChange={handleInputChange}
          ...
          from-green-500 to-green-300 hover:from-green-300 hover:to-green-500'
					type='submit' disabled={updatingTransaction}
				>
